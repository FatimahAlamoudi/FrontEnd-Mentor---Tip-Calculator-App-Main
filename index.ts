...
let totalTax = (<HTMLBodyElement>document.querySelector('.number-tip-amount'));
let button1 = (<HTMLButtonElement>document.querySelector('.tip-1'));
let button2 = (<HTMLButtonElement>document.querySelector('.tip-2'));
let button3 = (<HTMLButtonElement>document.querySelector('.tip-3'));
let button4 = (<HTMLButtonElement>document.querySelector('.tip-4'));
let button5 = (<HTMLButtonElement>document.querySelector('.tip-5'));
let resetButton = (<HTMLButtonElement>document.querySelector('.reset-btn'));
let custom = (<HTMLInputElement>document.querySelector('.custom-input'));
let tip = 0; 
let formLabelError = (<HTMLBodyElement>document.querySelector('.error'));
let peopleNoValue: number;
